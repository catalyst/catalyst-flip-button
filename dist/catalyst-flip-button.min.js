...
b,d){b=!!d;switch(a){case "disabled":this.setAttribute("aria-disabled",b),b?(this.selectElement.setAttribute("disabled",""),this.hasAttribute("tabindex")&&(this._tabindexBeforeDisabled=this.getAttribute("tabindex"),this.removeAttribute("tabindex"),this.blur())):(this.selectElement.removeAttribute("disabled"),this.hasAttribute("tabindex")||void 0===this._tabindexBeforeDisabled||null===this._tabindexBeforeDisabled||this.setAttribute("tabindex",this._tabindexBeforeDisabled))}}_onKeyDown(a){if(!a.altKey)switch(a.keyCode){case e._KEYCODE.SPACE:case e._KEYCODE.ENTER:a.preventDefault();
this._flip();break;case e._KEYCODE.LEFT:case e._KEYCODE.UP:a.preventDefault();this.previous();break;case e._KEYCODE.RIGHT:case e._KEYCODE.DOWN:a.preventDefault(),this.next()}}_onClick(a){0===a.button&&this._onLeftClick()}_onMouseUp(a){2===a.button&&this._onRightClick()}_onLeftClick(){this.focus();this.next()}_onRightClick(){this.focus();this.previous()}notifySelectedOptionChanged(){if(null!==this._selectElement&&0!==this._selectElement.length){var a=this._selectElement.options[this._selectElement.selectedIndex];
